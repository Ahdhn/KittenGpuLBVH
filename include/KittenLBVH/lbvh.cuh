...
namespace Kitten {
/// <summary>
/// Very simple high-performance GPU LBVH that takes in a list of bounding boxes
/// and outputs overlapping pairs. Side note: null bounds (inf, -inf) as inputs
...
class LBVH
{
   public:
    ...
    struct node
    {
        ...
        int fence;     // This subtree have indices between fence and current
                       // index. Negative if leaf
   ...
   public:
    ...
    /// </summary>
    /// <param name="d_res">Device pointer with pairs containing (in order) the
    /// calling BVH object ID and then the other BVH object ID.</param> <param
    /// name="resSize">The number of entries allocated</param> <param
    /// name="other">The other BVH</param> <returns>The number of unique
    /// collision pairs written</returns>
